...
res = run_winrm(
    ...
    command="pwd; Invoke-WebRequest -Uri 'https://ibm.box.com/shared/static/w26pu9sm69l6ysr2xklvoh9nkxgah23b.zip' -OutFile 'GIM_install.zip';Expand-Archive -Path 'GIM_install.zip' -DestinationPath '.'",
    command_type="ps",
    transport="ntlm",
    use_ssl=False,  # HTTP
)
