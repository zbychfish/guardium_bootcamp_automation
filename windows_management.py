...
res = run_winrm(
    ...
    command="Invoke-WebRequest -Uri https://ibm.box.com/shared/static/w26pu9sm69l6ysr2xklvoh9nkxgah23b.zip -OutFile C:\\Users\\Administrator\\Desktop\\GIM_install.zip';Expand-Archive -Path C:\\Users\\Administrator\\Desktop\\GIM_install.zip -DestinationPath C:\\Users\\Administrator\\Desktop",
    command_type="ps",
    transport="ntlm",
    use_ssl=False,  # HTTP
)
